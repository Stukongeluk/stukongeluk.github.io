...
export class ProjectsComponent {
  ...
  projects = signal<Project[]>([
    ...
    },
    {
      ...
      description: 'A 24/7 autonomous AI agent in Docker on my Synology NAS using free Hermes models and Discord. Powers daily freelance contract scanning with CV match scoring, and automated daily CBR exam question generation for CapyDrive.',
